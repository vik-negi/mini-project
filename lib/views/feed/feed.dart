                                                                    ...
                                                                    ? Container(
                                                                        ...
                                                                        child: Row(
                                                                            ...
                                                                            children: [
                                                                              CircleAvatar(
                                                                                radius: 25,
                                                                                backgroundImage: NetworkImage(commonVM.commentList[index].userImage),
                                                                              ),
                                                                              const SizedBox(
                                                                                width: 10,
                                                                              ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        ...
        WebSideBar(title: 'Home', icon: Icons.home),
        WebSideBar(title: 'Explore', icon: Icons.explore),
        WebSideBar(title: 'Profile', icon: Icons.person),
        WebSideBar(title: 'Chat', icon: CupertinoIcons.chat_bubble_2_fill),
